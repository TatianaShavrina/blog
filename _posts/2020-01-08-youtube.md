...
If you are a researcher who would like to 
...
You shound have Firefox installed to use the code below -- or change for [your browser](https://selenium-python.readthedocs.io/api.html).
...
CSSSelector is quite optional here, you can use eigher lxml or regular expressions, but the library in concern IMHO is most convenient for collecting the trees of comments. 
...
The code above has some magic numbers, like limit=100 default parameter in comments_main -- consiously not so big as the crawler is illustrating a collection of a small scientific corpus. 
...
Full Jupyter Notebook can be found [here](https://github.com/TatianaShavrina/crawlers/blob/master/youtube_crawl_demo.ipynb)
